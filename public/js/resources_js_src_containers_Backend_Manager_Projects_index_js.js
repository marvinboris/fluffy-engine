"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_Manager_Projects_index_js"],{
...
/***/ "./resources/js/src/containers/Backend/Manager/Projects/index.js":
/*!***********************************************************************!*\
  !*** ./resources/js/src/containers/Backend/Manager/Projects/index.js ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _store_actions_backend_projects__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../store/actions/backend/projects */ "./resources/js/src/store/actions/backend/projects.js");
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          form = _this$props$content$c.pages.projects.form,
          _this$props$backend$p = _this$props.backend.projects.projects,
          projects = _this$props$backend$p === void 0 ? [] : _this$props$backend$p;
      var lang = localStorage.getItem('backend_lang');
      var data = projects.map(function (project) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_4__.updateObject)(project, {
          title: project.title[lang],
          description: project.description[lang],
          experience: project.experience && project.experience[lang],
          date: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_4__.convertDate)(project.date),
          technologies: project.technologies.map(function (technology) {
            return technology.name;
          }).join(' · '),
          links: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.Fragment, {
            children: [project.github && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("a", {
              className: "text-decoration-none text-".concat(window.APP_PRIMARY_COLOR, " fab fa-github mr-2"),
              href: project.github,
              target: "_blank"
            }), project.link && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("a", {
              className: "text-decoration-none text-".concat(window.APP_SECONDARY_COLOR, " fas fa-external-link-alt"),
              href: project.link,
              target: "_blank"
            })]
          }),
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_4__.convertDate)(project.created_at),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions_backend_projects__WEBPACK_IMPORTED_MODULE_3__["default"].get(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions_backend_projects__WEBPACK_IMPORTED_MODULE_3__["default"]["delete"](id));
    },
    reset: function reset() {
      return dispatch(_store_actions_backend_projects__WEBPACK_IMPORTED_MODULE_3__["default"].reset());
    }
  };
};
