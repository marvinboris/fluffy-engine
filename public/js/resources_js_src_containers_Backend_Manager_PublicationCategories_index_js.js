"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_Manager_PublicationCategories_index_js"],{
...
/***/ "./resources/js/src/containers/Backend/Manager/PublicationCategories/index.js":
/*!************************************************************************************!*\
  !*** ./resources/js/src/containers/Backend/Manager/PublicationCategories/index.js ***!
  \************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _store_actions_backend_publication_categories__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../store/actions/backend/publication-categories */ "./resources/js/src/store/actions/backend/publication-categories.js");
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          _this$props$backend$p = _this$props.backend.publication_categories.publication_categories,
          publication_categories = _this$props$backend$p === void 0 ? [] : _this$props$backend$p;
      var lang = localStorage.getItem('lang');
      var data = publication_categories.map(function (publication_category) {
        var name = publication_category.name[lang];
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_5__.updateObject)(publication_category, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_5__.convertDate)(publication_category.created_at),
          name: name,
          action: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_components_Backend_UI_List_Action__WEBPACK_IMPORTED_MODULE_3__["default"], {
            props: _this.props,
            resource: "publication-categories",
            item: publication_category
          })
        });
      });
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions_backend_publication_categories__WEBPACK_IMPORTED_MODULE_4__["default"].get(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions_backend_publication_categories__WEBPACK_IMPORTED_MODULE_4__["default"]["delete"](id));
    },
    reset: function reset() {
      return dispatch(_store_actions_backend_publication_categories__WEBPACK_IMPORTED_MODULE_4__["default"].reset());
    }
  };
};
