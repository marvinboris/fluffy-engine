"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_Manager_PublicationCategories_Edit_js"],{
...
/***/ "./resources/js/src/containers/Backend/Manager/PublicationCategories/Add.js":
/*!**********************************************************************************!*\
  !*** ./resources/js/src/containers/Backend/Manager/PublicationCategories/Add.js ***!
  \**********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _store_actions_backend_publication_categories__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../store/actions/backend/publication-categories */ "./resources/js/src/store/actions/backend/publication-categories.js");
...
var Add = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Add, [{
    ...
    value: function componentDidUpdate(prevProps) {
      _utility__WEBPACK_IMPORTED_MODULE_6__.add.lifecycle.componentDidUpdate('publication_categories', 'publication_category')(prevProps, this.props, this.state, this.setState.bind(this), this.resetState);
    }
  }, {
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          form = _this$props$content$c.backend.pages.publication_categories.form,
          languages = _this$props$content.languages,
          loading = _this$props.backend.publication_categories.loading;
      ...
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_utility__WEBPACK_IMPORTED_MODULE_6__.add.lifecycle.render, {
        className: "PublicationCategories",
        props: this.props,
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(id) {
      return dispatch(_store_actions_backend_publication_categories__WEBPACK_IMPORTED_MODULE_5__["default"].show(id));
    },
    post: function post(data) {
      return dispatch(_store_actions_backend_publication_categories__WEBPACK_IMPORTED_MODULE_5__["default"].post(data));
    },
    patch: function patch(id, data) {
      return dispatch(_store_actions_backend_publication_categories__WEBPACK_IMPORTED_MODULE_5__["default"].patch(id, data));
    },
    reset: function reset() {
      return dispatch(_store_actions_backend_publication_categories__WEBPACK_IMPORTED_MODULE_5__["default"].reset());
    }
  };
};
...
/***/ "./resources/js/src/containers/Backend/Manager/PublicationCategories/Edit.js":
/*!***********************************************************************************!*\
  !*** ./resources/js/src/containers/Backend/Manager/PublicationCategories/Edit.js ***!
  \***********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var _Add__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Add */ "./resources/js/src/containers/Backend/Manager/PublicationCategories/Add.js");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react/jsx-runtime */ "./node_modules/react/jsx-runtime.js");
...
/***/ "./resources/js/src/store/actions/backend/publication-categories.js":
/*!**************************************************************************!*\
  !*** ./resources/js/src/store/actions/backend/publication-categories.js ***!
  \**************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var resource = function resource(type) {
  ...
  return _shared_utility__WEBPACK_IMPORTED_MODULE_0__.manageResource.apply(void 0, ['publication-categories', {
    start: function start() {
      return {
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.PUBLICATION_CATEGORIES_START
      };
    },
    success: function success(data) {
      return _objectSpread({
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.PUBLICATION_CATEGORIES_SUCCESS
      }, data);
    },
    fail: function fail(error) {
      return {
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.PUBLICATION_CATEGORIES_FAIL,
        error: error
      };
    }
  }, type].concat(params));
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  reset: function reset() {
    return {
      type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.PUBLICATION_CATEGORIES_RESET
    };
  },
