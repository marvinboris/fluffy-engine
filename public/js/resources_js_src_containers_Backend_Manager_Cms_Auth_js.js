  ...
  _createClass(Auth, [{
    ...
    value: function render() {
      ...
      var mainContent = languages.map(function (language) {
        var data = cms.pages[language.abbr].auth;
        ...
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)("div", {
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_utility__WEBPACK_IMPORTED_MODULE_9__.LanguageWithPages, {
            cmsExample: cmsExample.pages["en"].auth,
            cmsValue: cmsValue,
            language: language,
            part: "auth"
          })
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      if (nextProps.backend.cms.cms && prevState.app_name === '') {
        ...
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_11__.updateObject)(prevState, _objectSpread({}, auth));
      }
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    ...
    patch: function patch(data) {
      return dispatch((0,_store_actions_backend_cms__WEBPACK_IMPORTED_MODULE_10__.patchCms)('auth', data));
    },
