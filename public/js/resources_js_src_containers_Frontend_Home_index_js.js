...
var Home = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Home, [{
    ...
    value: function render() {
      ...
      if (!this.state.isMounted) document.title = "".concat(this.props.content.cms.pages.frontend.header.menu.home, " | ").concat(document.head.querySelector('meta[name="base-title"]').content);
