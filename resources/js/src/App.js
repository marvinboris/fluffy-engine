...
const importedRoutes = {
    ...
    Backend: {
        ...
        Manager: {
            ...
            Experiences: {
                Index: lazy(() => import('./containers/Backend/Manager/Experiences')),
                Add: lazy(() => import('./containers/Backend/Manager/Experiences/Add')),
                Edit: lazy(() => import('./containers/Backend/Manager/Experiences/Edit')),
            },
            Skills: {
                Index: lazy(() => import('./containers/Backend/Manager/Skills')),
                Add: lazy(() => import('./containers/Backend/Manager/Skills/Add')),
                Edit: lazy(() => import('./containers/Backend/Manager/Skills/Edit')),
            },
            Projects: {
                Index: lazy(() => import('./containers/Backend/Manager/Projects')),
                Add: lazy(() => import('./containers/Backend/Manager/Projects/Add')),
                Edit: lazy(() => import('./containers/Backend/Manager/Projects/Edit'))
            },
            Technologies: {
                ...
                <Route path={['/user', '/admin']}>
                    <BackendManagerLayout>
                        <Switch>
                            ...
                            <Route path="/:manager/experiences/:id/edit" component={importedRoutes.Backend.Manager.Experiences.Edit} />
                            <Route path="/:manager/experiences/add" component={importedRoutes.Backend.Manager.Experiences.Add} />
                            <Route path="/:manager/experiences" component={importedRoutes.Backend.Manager.Experiences.Index} />

                            <Route path="/:manager/skills/:id/edit" component={importedRoutes.Backend.Manager.Skills.Edit} />
                            <Route path="/:manager/skills/add" component={importedRoutes.Backend.Manager.Skills.Add} />
                            <Route path="/:manager/skills" component={importedRoutes.Backend.Manager.Skills.Index} />

                            <Route path="/:manager/projects/:id/edit" component={importedRoutes.Backend.Manager.Projects.Edit} />
                            <Route path="/:manager/projects/add" component={importedRoutes.Backend.Manager.Projects.Add} />
                            <Route path="/:manager/projects" component={importedRoutes.Backend.Manager.Projects.Index} />

                            <Route path="/:manager/technologies/:id/edit" component={importedRoutes.Backend.Manager.Technologies.Edit} />
                            <Route path="/:manager/technologies/add" component={importedRoutes.Backend.Manager.Technologies.Add} />
                            <Route path="/:manager/technologies" component={importedRoutes.Backend.Manager.Technologies.Index} />
