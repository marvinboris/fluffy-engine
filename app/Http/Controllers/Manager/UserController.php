...
class UserController extends Controller
{
    ...
    public function show($type, $id)
    {
        ...
        if (!$user) return response()->json([
            'message' => UtilController::message($cms['pages'][$manager->language->abbr]['backend']['messages']['users']['not_found'], 'danger'),
        ]);
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            'message' => UtilController::message($cms['pages'][$manager->language->abbr]['backend']['messages']['users']['created'], 'success'),
        ]);
    }
    ...
    public function update(Request $request, $type, $id)
    {
        ...
        return response()->json([
            'message' => UtilController::message($cms['pages'][$manager->language->abbr]['backend']['messages']['users']['updated'], 'success'),
            'user' => $user,
        ]);
    }
    ...
    public function destroy($id)
    {
        ...
        return response()->json([
            'message' => UtilController::message($cms['pages'][$manager->language->abbr]['backend']['messages']['users']['deleted'], 'success'),
            'users' => $users,
            'total' => $total,
        ]);
    }
